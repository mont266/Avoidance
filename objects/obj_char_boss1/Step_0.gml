...
if(keyboard_check(vk_lshift)) && global.boost > 0 {
    ...
    maxspd = boostSpeed;
    global.boost -= 1;
    effect_create_above(ef_smoke, obj_char_boss1.x, obj_char_boss1.y, 1, c_gray);
...
effect_create_above(ef_smoke, obj_char_boss1.x, obj_char_boss1.y, choose(0, 1, 2), c_gray);
}
if global.playerhealth < 100 {
effect_create_above(ef_smoke, obj_char_boss1.x, obj_char_boss1.y, choose(1, 2, 3), c_gray);
}
